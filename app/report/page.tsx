...
<GoogleMapsComponent 
  onLocationSelect={(location) => {
    console.log('Selected location:', location); // Debug: See what's coming
    setNewReport(prev => ({
      ...prev,
      location: 
...
<input
  ...
  className="mt-2 w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none bg-gray-100"
